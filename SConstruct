...
#from python.buildhelp import RATENVFILE, src_module, build_list
from buildhelp import RATENVFILE
from buildhelp import src_module
from buildhelp import build_list
