...
//this code was not actually doing anything because the bytes were not being tracked before in the first place, but keep commented for histogrical reasons.
/*
